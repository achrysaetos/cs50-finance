...
Do not forget to remove your database url from app.js and your api key from goto.js 
    and instead set them as environment variables!!!

run "DEBUG=cs50-finance:* npm run devstart"
...
cannot buy more than you have in cash, cannot sell other stocks nor more than you have in shares